...
from be.orderstatus import Order_Status as ords
...
class TestDelivery:
    ...
    def test_order_status(self):
        code,_x = ords.order_status(self,self.order_id)
        assert code == 200

    def test_my_order(self):
        code,_x = ords.my_order(self)
        assert  code == 200

    def test_cancel_order(self):
        code = ords.cancel_order(self, self.order_id)
        assert  code == 200
